...
Procédons directement à la création d'un projet, pour cela il suffit seulement de cliquer sur le menu "Fichier" puis "Assistant de projet..." ou avec le raccourci calvier "Ctrl+Shift+N". 
Une boite de dialogue s'ouvrira,  

![](captures/projet_assistant.JPG)

Cliquez sur "suivant", vous aurez une page pour le nom et description de votre projet, 

![](captures/projet_assistant_nom.JPG)
...
![](captures/projet_assistant_dimension.JPG)
...
![](captures/projet_assistant_visibilite.JPG)
