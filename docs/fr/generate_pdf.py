...
def build_cover():
    ...
    for line in [
        "Interface graphique · Matériaux · Modèles",
        "Avatars · Boucles · Granulométrie",
        "Conditions aux limites · Lois de contact",
        "Maçonnerie · Corps déformables · Calcul",
        "Post-traitement · Variables dynamiques · Architecture",
    ]:
...
# ─── Table of contents ─────────────────────────────────────────────────────────
CHAPTERS = [
    ("1",  "Introduction à l'interface",        "interface.md"),
