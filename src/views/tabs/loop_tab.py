...
class LoopTab(BaseTab):
    ...
    def _setup_ui(self):
        ...
        self.use_soa_check.setToolTip(
            ...
            "grands nombres d'itérations.\n\n"
            "Types supportés : rigidDisk, rigidSphere, rigidDiscreteDisk,\n"
            "rigidCluster, rigidCylinder, rigidPolygon (régulier), rigidPolyhedron\n"
            "(régulier).\n"
            "Le template ne doit pas contenir : contactors, vertices, is_hollow,\n"
            "axis, ni de génération personnalisée (vertices explicites).\n"
            "Les particules produites ne seront pas individuellement éditables.\n"
